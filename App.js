...
export default class App extends Component<Props> {
  ...
  componentDidMount() {
    getNewShuffle().then(cards => this.setState({ cards: cards.cards }));
  }
  ...
  render() {
    ...
    const imageUrl = isShowSecondCard
      ? { uri: cards[1].image }
      : require("./Assets/card-back.jpg");
    return (
      <View style={styles.container}>
        ...
        <Button text="Up" onPress={this.onUpPressed} />
        <Button text="Down" onPress={this.onDownPressed} />
      </View>
    );
  }
}
